...
<body bgcolor="Turquoise">
	   <form name="approverform" method="post" action="UpdateStatusController" >
           <table border="3" border color="black" align="center">
			<%

			Object obj=request.getAttribute("verifyform");
	...
	<h1>LOAN APPLICATION FORM</h1>
		...
		<tr align="center">
			...
			<tr align="center">
				...
				<td><input type="text" name="CREDITRATING"
			...
			<tr align="center">
				...
				<tr align="center">
				<td><b>KYC Check</b></td>
				<td><input type="text" name="KYCCHECK" 
				placeholder="Kyc Check" maxlenth="20" size="40"></td>
				...
				<td><input type="number" name="LOANAMOUNTGRANTED" 
		...
		<tr align="center">
				...
				<td><input type="number" name="tenureapproved" 
